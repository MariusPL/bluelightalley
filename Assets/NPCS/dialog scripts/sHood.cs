...
public class sHood : MonoBehaviour
{
            ...
            case 1:
                {
                    ...
                    script.SwapS("Yo new face around here.");
                    script.SwapD("I'm Hood.");
                    script.SwapT("I'll giv you a clue, I'm not gun' be the killer.\n I'm more of a victim guy, y'know.");
                    script.SwapF("Don't flirt with me chief, I'm beyond that.");
                    script.SwapI("What do y'need, like ask questions type shit, I'm not 'fraid of answering y'know, maybe talk about the case or something.");
                    script.SwapDisabled("I wear hoodies in honor of m' name.");
                    break;
                }
            case 3:
                {
