...
public class sSistemaEverstar : MonoBehaviour
{
    ...
    private void StartingM()
    {
        ...
        switch (days)
        {
            case 3:
                {
                    script.SwapS("Hey.");
                    script.SwapD("My pleasure, I'm Krystal.+");
                    script.SwapT("So, what do you need Detective?+");
                    script.SwapF("Hola facha.+");
                    script.SwapI("Why would I be scared of you?+");
                    script.SwapDisabled("Bye facha.");
            ...
            case 3:
                {
                    if (dd3)
                    {
                        // script.SwapYes("Well I haven't done anything... What about you?+");
                        script.SwapOp("Doing well", "How was yesterday");
                        script.SwapYes("nice");
                        script.SwapNo("nice2");
                    ...
                    {
                        //script.SwapYes("Oh yes now I do wanna find out. Who are you.+");
                        script.SwapOp("I'm the one asking questions","I'll tell you if you tell me first");
                        script.SwapYes("Alright calm down sir, why so serious. I'm Sistema.");
                        script.SwapNo("I reject the offer.");
            ...
            case 3:
                {
                    if (dd3)
                    {
                        // script.SwapNo("Pretty fun, I've met a lot of people.+");
                        script.SwapOp("Who","nice");
                        script.SwapYes("well, this man right here, his name is");
                        script.SwapNo("Well nothing, thats it.");
            ...
            case 3:
                {
                    ...
                    //script.SwapD("My pleasure, I'm Krystal.+");
                    script.SwapOp("How was your day","How's the night");
                    script.SwapYes("Well I haven't done anything... What about you?+");
                    script.SwapNo("Pretty fun, I've met a lot of people.+");
            ...
            case 3:
                {
                    ...
                    //script.SwapT("So, what do you need Detective?+");
                    script.SwapOp("About yourself", "About anyone else");
                    script.SwapYes("I'm Loreane, I come here to have a drink before going to sleep.");
                    script.SwapNo("Well i know about");
                    break;
                }
            ...
            case 3:
                {
                    ...
                    //hi facha
                    script.SwapOp("Compliment", "Mean joke");
                    script.SwapYes("I get that often, thanks.");
                    script.SwapNo("Wtf lol lmao");
                    break;
                }
            ...
            case 3:
                {
                    ...
                    script.SwapOp("You don't want to find out", "My intel could destroy you.");
                    script.SwapYes("Oh yes now I do wanna find out. Who are you.+");
                    script.SwapNo("I've met a lot of people with intel who ended up doing nothing.");
                    break;
                }
