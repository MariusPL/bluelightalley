...
//Tiene una banda de rock con sus amigos, le gustan los 2000s, le gusta dibujar, pizza y birra.
//Es timida en realidad. trabaja en un coso de traduccion y de noche diseño visual, viene al bar desps del trabajo audiovisual porq esta al lado. Tambien queire salir de su zona de confort
public class sMilaEvermore : MonoBehaviour
{
    ...
    private void GetReputation()
    {
        ...
        switch (maxIndex)
        {
            case 0:
                {
                    script.SwapS("Hi.");
                    script.SwapD("I'm Mila nice to meet you.+");
                    script.SwapT("");
                    script.SwapF("");
                    script.SwapI("");
                    script.SwapDisabled("");
